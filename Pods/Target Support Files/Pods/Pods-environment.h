...
#define COCOAPODS_POD_AVAILABLE_BeanTransitionManager
#define COCOAPODS_VERSION_MAJOR_BeanTransitionManager 0
#define COCOAPODS_VERSION_MINOR_BeanTransitionManager 2
#define COCOAPODS_VERSION_PATCH_BeanTransitionManager 1
