...
{
    self = [self initWithTitle:title message:nil timeout:1.5 dismissible:YES];
    return self;
}
...
- (void)showForground
{
    ...
    [self showInView:window Forground:YES];
}
...
- (void)layoutSubviews
{
    ...
    NSString *orgin                    = self.title;
    NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc] init];
    paragraphStyle.lineBreakMode       = NSLineBreakByWordWrapping;
    NSDictionary *attributes           = @{NSFontAttributeName:[UIFont systemFontOfSize:15],
                                           NSParagraphStyleAttributeName:paragraphStyle.copy};
    
    CGSize titleSize       = [orgin boundingRectWithSize:CGSizeMake(320,
                                                                   480)
    ...
    if (self.message) {
        NSString *orginMsg                    = self.message;
        NSMutableParagraphStyle *paragraphStyle = [[NSMutableParagraphStyle alloc] init];
        paragraphStyle.lineBreakMode       = NSLineBreakByWordWrapping;
        NSDictionary *attributes           = @{NSFontAttributeName:[UIFont systemFontOfSize:15],
                                               NSParagraphStyleAttributeName:paragraphStyle.copy};
        
        messageSize       = [orginMsg boundingRectWithSize:CGSizeMake(320,
                                                                        480)
                                                     options:NSStringDrawingUsesLineFragmentOrigin
                                                  attributes:attributes
                                                     context:nil].size;
