...
@interface FGalleryViewController : StandarViewController <UIScrollViewDelegate,FGalleryPhotoDelegate,FGalleryPhotoViewDelegate> {
    ...
    UILabel *_lblImageName;
    UIView *_vImageNameBG;
