...
- (void)commonInit{
    ...
    _cornerRadius = 0.0f;
    _borderWidth = 1.0f;
    _roundedCorners = TKRoundedCornerNone;
    _drawnBordersSides = TKDrawnBorderSidesNone;
...
- (void)drawRect:(CGRect)rect{
    ...
    CGFloat leftInsets = _drawnBordersSides & TKDrawnBorderSidesLeft ? halfLineWidth/3 : 0.0f;
    CGFloat rightInsets = _drawnBordersSides & TKDrawnBorderSidesRight ? halfLineWidth/3 : 0.0f;
